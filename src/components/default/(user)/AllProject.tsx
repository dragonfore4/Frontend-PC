    ...
    return (
        <div className='h-full'>
            <div className='flex justify-between items-center mb-8'>
                <h1 className=' text-2xl font-semibold '>All Project DashBoard <span className='text-gray-500'>{projects.length} Total</span></h1>
            ...
            <div className='bg-white p-4 rounded shadow'>
                <table className="w-full">
                    ...
                    <tbody>
                        {projectsEachPage.map((project, index) => (
                            <tr key={index} className='border-b'>
                                ...
                                <td className='flex justify-between'>
                                    ...
                                    <button
                                        ...
                                        className={`${auth!.user != "admin" ? "text-white": "text-green-500"} `}
